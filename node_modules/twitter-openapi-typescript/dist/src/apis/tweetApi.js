...
var TweetApiUtils = /** @class */ (function () {
    function TweetApiUtils(api, flag, initOverrides) {
        this.api = api;
        this.flag = flag;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, apiFn(args, this.initOverrides(this.flag[param.key]))];
                    case 1:
                        response = _c.sent();
    ...
    TweetApiUtils.prototype.getHomeTimeline = function () {
    ...
    TweetApiUtils.prototype.getHomeLatestTimeline = function () {
        return __awaiter(this, arguments, void 0, function (param) {
            var args, response;
            if (param === void 0) { param = {}; }
            return __generator(this, function (_a) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                convertFn: function (e) { var _a; return (0, utils_1.errorCheck)((_a = e.data.list) === null || _a === void 0 ? void 0 : _a.tweetsTimeline.timeline, e.errors).instructions; },
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                convertFn: function (e) { var _a; return (0, utils_1.errorCheck)((_a = e.data.user) === null || _a === void 0 ? void 0 : _a.result.timeline.timeline, e.errors).instructions; },
                                key: 'UserTweets',
                                param: args,
                            })];
                    case 1:
    ...
    TweetApiUtils.prototype.getBookmarks = function () {
        return __awaiter(this, arguments, void 0, function (param) {
            var args, response;
            if (param === void 0) { param = {}; }
            return __generator(this, function (_a) {
    ...
    TweetApiUtils.prototype.getCommunityTweetsTimeline = function (param) {
        return __awaiter(this, void 0, void 0, function () {
            var args, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        args = __assign(__assign(__assign(__assign({ communityId: param.communityId }, (param.count == undefined ? {} : { count: param.count })), (param.cursor == undefined ? {} : { cursor: param.cursor })), (param.rankingMode == undefined ? {} : { rankingMode: param.rankingMode })), param.extraParam);
                        return [4 /*yield*/, this.request({
                                apiFn: this.api.getCommunityTweetsTimelineRaw,
                                convertFn: function (e) { var _a; return (0, utils_1.errorCheck)((_a = e.data) === null || _a === void 0 ? void 0 : _a.communityResults.result.rankedCommunityTimeline.timeline, e.errors).instructions; },
    ...
    TweetApiUtils.prototype.getCommunityMediaTimeline = function (param) {
        return __awaiter(this, void 0, void 0, function () {
            var args, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        args = __assign(__assign(__assign({ communityId: param.communityId }, (param.count == undefined ? {} : { count: param.count })), (param.cursor == undefined ? {} : { cursor: param.cursor })), param.extraParam);
                        return [4 /*yield*/, this.request({
                                apiFn: this.api.getCommunityMediaTimelineRaw,
                                convertFn: function (e) { var _a; return (0, utils_1.errorCheck)((_a = e.data) === null || _a === void 0 ? void 0 : _a.communityResults.result.communityMediaTimeline.timeline, e.errors).instructions; },
